...
# "Maybe" means sanity-check, not act
When the user opens an instruction with "maybe" ("maybe do xyz") they think it is a good idea but know they lack full context. Sanity-check the proposal first and push back with easy-to-understand pros/cons if warranted, rather than just doing it.
